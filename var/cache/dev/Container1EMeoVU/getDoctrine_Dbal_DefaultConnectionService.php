...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['connection_override_options' => ['dbname' => 'promobit', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 190650], 'dbname' => 'promobit', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 190650, 'driver' => 'pdo_mysql', 'url' => $container->getEnv('resolve:DATABASE_URL'), 'driverOptions' => [], 'defaultTableOptions' => []], $a, $b, []);
    }
}
